...
const FilterPopover = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center bg-white w-full lg:w-[800px]">
      <header className="flex items-center justify-between h-12 w-full">
        <h4 className="text-primary-900 font-bold text-[22px]">Filter by:</h4>
        ...
        <form onSubmit={applyFilter} className="w-full p-5 flex flex-col md:flex-row flex-wrap gap-y-6">
          <div className="flex flex-col gap-y-2 w-full md:w-1/2 px-0 md:px-3 lg:px-0">
            <label className="text-base text-primary-900 font-medium" htmlFor="statue">Status</label>
          ...
          <div className="flex flex-col gap-y-2 w-full md:w-1/2 px-0 md:px-3 lg:px-0">
            <label className="text-base text-primary-900 font-medium" htmlFor="patient_name">Patient Name</label>
          ...
          <div className="flex flex-col gap-y-2 w-full md:w-1/2 px-0 md:px-3 lg:px-0">
            <label className="text-base text-primary-900 font-medium" htmlFor="date_from">Date From</label>
            <input type="date" id="date_from" className="w-full lg:w-[224px] h-[40px] rounded-md shadow-primary px-2 outline-none text-primary-200" />
          </div> 
          <div className="flex flex-col gap-y-2 w-full md:w-1/2 px-0 md:px-3 lg:px-0">
            <label className="text-base text-primary-900 font-medium" htmlFor="date_to">Date To</label>
            <input type="date" id="date_to" className="w-full lg:w-[224px] h-[40px] rounded-md shadow-primary px-2 outline-none text-primary-200" />
          </div> 

          <div className="ml-auto mt-6">
            <button className="bg-primary-base text-white rounded-md px-4 py-3">Apply</button>
          </div>
        </form>
