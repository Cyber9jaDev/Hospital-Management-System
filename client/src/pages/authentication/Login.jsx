...
import { signUpSlides } from "../../utils/Constants";
...
const Login = () => {
  ...
  return (
    <main className="flex h-screen w-full">
      <section className="w-full lg:w-1/2 flex flex-col h-full items-center justify-center">
        <div className='w-full px-5 md:px-0 md:w-auto'>
          ...
          <h4 className="text-dark-gray text-3xl font-bold font-lato mb-3">Log in to your account</h4>

          <p className="font-roboto text-base text-dark-gray mb-7">Welcome back! Select login method:</p>
          ...
          <form  onSubmit={handleFormSubmit}>
            <div className="form-group my-4">
              <div className="w-full px-4 flex items-center rounded-[12px] h-[50px] relative border-1 border-pinkish-purple">
            ...
            <div className="form-group mt-12">
              <button type='submit' className='w-full md:w-[387px] h-[50px] bg-primary-base text-base text-white rounded-md border-0 outline-0 font-roboto'> LOG IN </button>
            </div>
          </form>

          <p className='font-roboto text-base text-dark-gray-medium text-center mt-5'>Don’t have an account yet? <Link className="text-light-blue-base" to='/signup'> Sign Up</Link> </p>
        </div>
      </section>
      <section className="hidden w-full lg:w-1/2 lg:flex flex-col h-full bg-primary-base p-2 items-center justify-center">
